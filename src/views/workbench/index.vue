        ...
        <n-card rounded-10>
          <div flex items-center>
            ...
            <div ml-20>
              ...
              <n-gradient-text mt-5 text-12 op-60 gradient="linear-gradient(90deg, red 0%, green 50%, blue 100%)">
                他日若遂凌云志，敢笑黄巢不丈夫~
              </n-gradient-text>
            </div>
      ...
      <n-card title="项目" size="small" :segmented="true" mt-15 rounded-10>
        ...
        <div flex flex-wrap justify-around>
          <n-card
            ...
            size="small"
          >
            <p op-60>一个基于 Vue3、Vite3、TypeScript、Pinia、Unocss、Naive UI 的轻量级后台管理模板</p>
          </n-card>
          <div w-300 h-0 />
          <div w-300 h-0 />
          <div w-300 h-0 />
